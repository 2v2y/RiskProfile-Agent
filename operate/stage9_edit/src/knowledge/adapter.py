...
if __name__ == "__main__":
    ...
    if src is None:
        src = r"G:\Projects\intern_project\CahngeDirect_eassy\origin_data\from_student2\student2"
    if out is None:
        out = r"G:\Projects\intern_project\CahngeDirect_eassy\operate\stage1\knowledge"
    print(json.dumps(run(src, out), ensure_ascii=False, indent=2))
